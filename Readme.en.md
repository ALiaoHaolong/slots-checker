...
This is a Fabric-based Minecraft mod that provides administrators with a set of /slots-checker commands to view and modify any player's inventory, hotbar, ender chest, armor, and offhand item slots.

When installed on the client, it provides in-game interface translations. Supports en_us, zh_cn, zh_hk, and zh_tw languages.
