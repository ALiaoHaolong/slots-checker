...
[![Homepage](https://img.shields.io/badge/HOMEPAGE-D0D5DA?style=for-the-badge)](https://aliaohaolong.github.io/slots-checker)
...
- [Creative inventory problem](https://aliaohaolong.github.io/slots-checker/guide/creative-inventory-problem.html).

## Commands

1. `/slots-checker inventory <player>`  
   Open the player's inventory interface.  
   <img src="https://cdn.jsdelivr.net/gh/ALiaoHaolong/slots-checker@master/docs/public/images/inventory.png" alt="Inventory" width="400"/>

2. `/slots-checker hotbar <player>`  
   Open the player's hotbar interface.  
   <img src="https://cdn.jsdelivr.net/gh/ALiaoHaolong/slots-checker@master/docs/public/images/hotbar.png" alt="Hotbar" width="400"/>

3. `/slots-checker ender <player>`  
   Open the player's ender chest interface.  
   <img src="https://cdn.jsdelivr.net/gh/ALiaoHaolong/slots-checker@master/docs/public/images/ender.png" alt="Ender Chest" width="400"/>
...
4. `/slots-checker armor <player>`  
   ...
   <img src="https://cdn.jsdelivr.net/gh/ALiaoHaolong/slots-checker@master/docs/public/images/armor.png" alt="Armor" width="400"/>

5. `/slots-checker offhand <player>`  
   Open the player's offhand interface.  
   The last 8 fields are invalid.  
   <img src="https://cdn.jsdelivr.net/gh/ALiaoHaolong/slots-checker@master/docs/public/images/offhand.png" alt="Offhand" width="400"/>
